...
#define __CLS1_CONFIG_H
  ...
  #define CLS1_CONFIG_DEFAULT_SERIAL_RECEIVE_FCT_NAME   AS2_RecvChar
    /*!< Function name to read a character and returning ERR_OK if it was successful */

  #define CLS1_CONFIG_DEFAULT_SERIAL_SEND_FCT_NAME   AS2_SendChar
    /*!< Function name to send a character and returning ERR_OK if it was successful */

  #define CLS1_CONFIG_DEFAULT_SERIAL_RXAVAIL_FCT_NAME   AS2_GetCharsInRxBuf
  ...
  #define CLS1_CONFIG_PROJECT_NAME_STRING    "MCUX_PE_KL25Z_FRTOS_FatFS_LCD"
#endif
